    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <section className="pt-32 pb-20 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-1/2 bg-brand-orange/20 blur-[120px] pointer-events-none"></div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold mb-6">
                            About <br /><span className="text-brand-orange">Mozilla Firefox Club</span>
                        </h1>
            ...
            <section className="py-20 bg-black/40 border-y border-white/5">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="glass p-10 rounded-3xl border border-brand-orange/20 relative overflow-hidden group">
                            <div className="absolute top-0 left-0 w-2 h-full bg-brand-orange"></div>
                            <Target size={40} className="text-brand-orange mb-6 group-hover:scale-110 transition-transform" />
                        ...
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="glass p-10 rounded-3xl border border-brand-yellow/20 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-2 h-full bg-brand-yellow"></div>
                            <Lightbulb size={40} className="text-brand-yellow mb-6 group-hover:scale-110 transition-transform" />
            ...
            <section className="py-24 relative">
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">Why Join <span className="text-brand-orange">Us?</span></h2>
                        ...
                        {[
                            ...
                            <div key={idx} className="flex flex-col gap-4">
                                <div className="flex items-center gap-3 mb-2">
                                    <CheckCircle className="text-brand-yellow flex-shrink-0" />
            ...
            {/* Timeline Section */}
            <section className="py-24 bg-gradient-to-b from-transparent to-brand-orange/5">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="flex items-center gap-4 mb-16 justify-center">
                        <History size={40} className="text-brand-orange" />
                        <h2 className="text-4xl md:text-5xl font-bold text-center">Our <span className="text-brand-orange">History</span></h2>
                    </div>

                    <div className="relative border-l-2 border-brand-orange/30 pl-8 ml-4 md:ml-0 md:pl-0 md:border-l-0">
                        {/* Desktop timeline line */}
                        <div className="hidden md:absolute left-1/2 top-0 bottom-0 w-[2px] bg-brand-orange/30 -translate-x-1/2"></div>
                        ...
                        <div className="space-y-12">
                            {timelineEvents.map((event, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Center Dot */}
                                        <div className="absolute left-[-41px] md:left-1/2 w-4 h-4 rounded-full bg-brand-orange border-4 border-background md:-translate-x-1/2 z-10"></div>

                                        <div className={`md:w-1/2 ${isEven ? 'md:text-left' : 'md:text-right'}`}>
                                            <h3 className="text-2xl font-bold mb-2">
                                                {event.title} <span className="text-brand-orange text-sm ml-2 bg-brand-orange/10 px-2 py-1 rounded inline-block">{event.year}</span>
                                            </h3>
            ...
            <section className="py-24 text-center">
                <div className="container mx-auto px-6">
                    ...
                    <Link href="/join">
                        <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-4 rounded-full bg-gradient-to-r from-brand-red to-brand-orange text-white font-bold text-lg shadow-lg hover:shadow-brand-orange/50 transition-all inline-flex items-center gap-2">
