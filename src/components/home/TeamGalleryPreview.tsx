                            ...
                            <div className="flex -space-x-4 items-center">
                                {TEAM_MEMBERS_PREVIEW.map((i) => (
                                    <motion.div 
                                        ...
                                        className="w-16 h-16 rounded-full bg-gradient-to-br from-brand-purple to-brand-cyan flex items-center justify-center text-xl font-black text-white border-4 border-black shadow-xl"
                                    >
                                        {i}
                                    </motion.div>
                                ))}
