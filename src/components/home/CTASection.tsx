            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-black mb-6 text-white tracking-tight">
                        Ready to join our <span className="text-brand-purple">community?</span>
                    </h2>
                    ...
                    <Link href="/join">
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.95 }} 
                            className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black font-black rounded-2xl hover:bg-brand-purple hover:text-white transition-all duration-300 shadow-xl group"
                        >
