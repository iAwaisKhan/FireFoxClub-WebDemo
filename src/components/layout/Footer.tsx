...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-900 text-gray-400 py-12 border-t border-gray-800 relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-0.5 bg-linear-to-r from-transparent via-brand-orange to-transparent opacity-20"></div>
            ...
            <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-10">
                <div className="col-span-1 md:col-span-2 space-y-4">
                    ...
                    <div className="flex gap-4 pt-4">
                        <a href="#" aria-label="GitHub" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all">
                            <Github size={20} />
                        </a>
                        <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all">
                            <Twitter size={20} />
                        </a>
                        <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all">
                            <Linkedin size={20} />
                        </a>
                        <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-orange hover:text-white transition-all">
                            <Instagram size={20} />
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        {["About Us", "Events", "Projects", "Team"].map((link) => (
                            <li key={link}>
                                <Link href={`/${link.toLowerCase().replace(" ", "-")}`} className="text-gray-400 hover:text-brand-orange transition-colors">
                                    {link}
                                </Link>
                            </li>
                        ))}
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        <li>
                            ...
                            <a href="mailto:hello@mozilla-vitbhopal.club" className="text-brand-orange hover:text-orange-600 transition-colors">
